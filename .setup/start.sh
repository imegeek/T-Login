...
#setup fonts
echo -e '\033[1;92m[?] Choose Your Fonts: '
read font
    if [[ $font = "1" ]] || [[ $font = "01" ]]
        then
...
exec sleep 1
        ...
        then
cd fonts > /dev/null 2>&1 && rm $PREFIX/share/figlet/'ANSI S.flf' > /dev/null 2>&1 && cp 'ANSI S.flf' $PREFIX/share/figlet > /dev/null 2>&1 && cd ..
...
exec sleep 1
        ...
        then
cd fonts > /dev/null 2>&1 && rm $PREFIX/share/figlet/'ANSI R.flf' > /dev/null 2>&1 && cp 'ANSI R.flf' $PREFIX/share/figlet > /dev/null 2>&1 && cd ..
